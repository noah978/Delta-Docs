...
4. Tap the plus button in the top right corner of the main screen to launch the in-app web browser. Go to the place where you normally download your ROMs, then find the game you want to download. Begin the download, and it'll automatically appear for you to play when it's done.
-->
...
**Can I enable/disable syncing for individual games?**
...
* Tap the plus button in the top right corner of the main screen to launch the in-app web browser. Go to any Delta skins website. Find the skin you want, and download it. It will automatically appear for you to select in the skin selection view when it's done.
